...
Once `init()` runs, the SDK starts detecting all 127 behavioral signal types without any additional code. You don't call `signal()` for rage clicks, dead clicks, form abandonment, scroll confusion, or mobile tap misses. Those just work.
...
const type: SignalType = 'rage_click'   // autocomplete across all 127 types
